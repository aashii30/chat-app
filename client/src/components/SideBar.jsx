...
const SideBar = () => {
  ...
  return (
    <div className={ `flex-1 bg-[#8185B2]/10 h-full p-5  overflow-y-scroll
     text-white max-sm:w-[95vw] transition-all duration-300 `}>
      <div className='pb-5'>
                ...
                <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md
                 bg-[#282142] border border-gray-600
                  text-gray-100 hidden group-hover:block'>
                    ...
                    <p onClick={()=> logout()}
                    className='cursor-pointer text-sm hover:text-white'>Logout</p>
                </div>
